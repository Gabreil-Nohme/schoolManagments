...
class AddParent extends Component
{
    ...
    public $catchError, $updateMode = false, $show_table = true, $photos,$Parent_id;
    ...
    public function submitForm()
    {
        try {
            ...
            $My_Parent->save();
            // 1انشاء ملف برقم الاب الوطني
            // 2اخذ اسم الصورة من الصورة المرفوعة
            // 3البرامتر الثالث مساره (disk$)
            //config->filesystem-[]
    ...
    public function edit($id)
    {
        ...
        $My_Parent = My_Parent::firstwhere('id', $id);
        $this->Parent_id = $id;
    ...
    public function submitForm_edit(){
        $My_Parent = My_Parent::firstwhere('id', $this->Parent_id);
