...
<head>
    ...
    <meta name="description" content="school manegment" />
    <meta name="author" content="Gabreil nohme" />
                        ...
                        <div class="login-fancy pb-40 clearfix">
                            ...
                            <div class="form-inline">
                                <a class="btn btn-default col-lg-3" title="طالب" href="{{route('login.show','student')}}">
                                    <img alt="user-img" Class="rounded-corners"  width="100px;" src="{{URL::asset('assets/images/student.png')}}">
                                </a>
                                <a class="btn btn-default col-lg-3" title="ولي امر" href="{{route('login.show','parent')}}">
                                    <img alt="user-img" Class="rounded-corners" width="100px;" src="{{URL::asset('assets/images/parent.png')}}">
                                </a>
                                <a class="btn btn-default col-lg-3" title="معلم" href="{{route('login.show','teacher')}}">
                                    <img alt="user-img" Class="rounded-corners" width="100px;" src="{{URL::asset('assets/images/teacher.png')}}">
                                </a>
                                <a class="btn btn-default col-lg-3" title="ادمن" href="{{route('login.show','web')}}">
                                    <img alt="user-img" Class="rounded-corners" width="100px;"  src="{{URL::asset('assets/images/admin.png')}}">
                                </a>
                            </div>
