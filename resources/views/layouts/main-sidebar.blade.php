        ...
        <div class="clearfix"></div>
                    ...
                    <li>
                        ...
                        <ul id="students-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('addStudent.create')}}">{{trans('main_trans.Add_student')}}</a> </li>
                            <li> <a href="{{route('addStudent.index')}}">{{trans('main_trans.Show_student')}}</a> </li>
                            <li> <a href="{{route('Promotion.create')}}">معلومات الترقيات</a> </li>
                            <li> <a href="{{route('Promotion.index')}}">ترقية الطلاب</a> </li>
                            <li> <a href="{{route('graduated.index')}}">الطلاب المتخرجين</a> </li>
                            <li> <a href="{{route('graduated.create')}}">تخريج الطلاب</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('Fees.create')}}">اضافة دفعات </a> </li>
                            <li> <a href="">اضافة دفعات للطلاب </a> </li>
                        </ul>
