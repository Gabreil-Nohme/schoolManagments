                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('addStudent.index')}}" target="_blank"><span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                                            ...
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                @forelse(\App\Models\Fee_invoice::latest()->take(10)->get() as $section)
                                                    <tr>
                                                        ...
                                                        <td>{{$section->fees->Fee_type == 1 ? 'سند قبض' :'سند صرف'}}</td>
