                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($students as $student)
                                            ...
                                            <td>{{$student->section->name_section}}</td>
                                                <td>
                                                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#Return_Student{{ $student->id }}" title="{{ trans('Grades_trans.restore') }}">ارجاع الطالب</button>
                                        ...
                                        @include('pages.Students.Graduated.Delate')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
